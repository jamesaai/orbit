  ...
  return (
    <div className="pagePadding">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="relative">
              ...
              >
                ...
                <h1 className="text-3xl sm:text-4xl font-extrabold text-zinc-900 dark:text-white mb-2 bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/70">
                  {text}
                </h1>
                <div
                  className={clsx(
        ...
        {loading ? (
          <div className="bg-white dark:bg-zinc-800 rounded-2xl shadow-sm p-8 sm:p-12 text-center border border-zinc-100 dark:border-zinc-700">
            <div className="w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-primary/10 to-primary/30 flex items-center justify-center">
              <IconHome className="w-10 h-10 sm:w-12 sm:h-12 text-primary" />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {workspace.settings.widgets.map((widget, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`px-6 py-5 ${widgetConfig.color} border-b border-zinc-100 dark:border-zinc-700`}
                  >
                    <div className="flex items-center gap-3">
          ...
          <div className="bg-white dark:bg-zinc-800 rounded-2xl shadow-sm p-8 sm:p-12 text-center border border-zinc-100 dark:border-zinc-700">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-zinc-900 dark:text-white mb-3 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300">
              Your dashboard is empty
            </h3>
            <p className="text-zinc-500 dark:text-zinc-400 mb-8 max-w-md mx-auto text-sm sm:text-base">
              Add widgets to your workspace to see important information at a
              glance
            </p>
            <button
              onClick={() =>
