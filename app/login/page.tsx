...
export default function LoginPage() {
  ...
  return (
    <>
      <div className="flex items-center justify-center min-h-screen px-4 overflow-hidden bg-infobg-light dark:bg-infobg-dark bg-cover bg-center bg-no-repeat">
        <div className="bg-white dark:bg-zinc-800 dark:bg-opacity-90 dark:backdrop-blur-lg max-w-md w-full rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-xl relative border border-zinc-200 dark:border-zinc-700">
            ...
            {["login", ...(oauthOnly ? [] : ["signup"])].map((m) => {
              ...
              return (
                <button
                  ...
                  className={`pb-2 font-semibold text-base sm:text-lg transition-colors ${
                    isActive ? activeClass : "text-zinc-500 dark:text-zinc-400"
                  }`}
                  type="button"
                  disabled={loading}
                >
          ...
          {mode === "login" && (
            <>
              <p className="font-bold text-2xl sm:text-3xl text-zinc-900 dark:text-white mb-2">
                👋 Welcome to Orbit
              </p>
              <p className="text-sm sm:text-base text-zinc-600 dark:text-zinc-300 mb-6">
                  ...
                  >
                    ...
                    <div className="flex items-center mb-2">
                      ...
                      <label
                        ...
                        className="text-sm text-zinc-600 dark:text-zinc-300 select-none cursor-pointer"
                      >
                        Show password
                      </label>
                    </div>
                    <div className="space-y-3">
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                        ...
                        <Button
                          type="submit"
                          classoverride="px-6 py-2 text-sm rounded-lg w-full sm:w-auto"
                          loading={loading}
                          disabled={loading}
                        >
                          Login
                        ...
                        <>
                          ...
                          <div className="w-full">
                            <button
                              ...
                              disabled={loading}
                              className="w-full flex items-center justify-center px-4 py-2.5 border border-zinc-300 dark:border-zinc-600 rounded-lg shadow-sm bg-white dark:bg-zinc-800 text-sm font-medium text-zinc-700 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
                              <img
                                src="/roblox.svg"
                                alt="Roblox"
            ...
            <>
              ...
              {signupStep === 2 && (
                <>
                  ...
                  <p className="text-center font-mono bg-zinc-700 dark:bg-zinc-900 text-white py-3 px-4 rounded-lg mb-4 select-all break-all">
                    {verificationCode}
                  </p>
        ...
        <div className="fixed bottom-4 left-4 z-40">
          <button
            ...
            className="text-left text-xs text-zinc-500 dark:text-zinc-400 hover:text-primary transition-colors"
            type="button"
          >
            © Copyright Notices
          </button>
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto max-w-sm rounded-lg bg-white dark:bg-zinc-800 p-6 shadow-xl border border-zinc-200 dark:border-zinc-700">
