        ...
        <div className="bg-white dark:bg-zinc-800 dark:bg-opacity-90 dark:backdrop-blur-lg max-w-md w-full rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-xl relative border border-zinc-200 dark:border-zinc-700">
          {selectedSlide === 0 && (
            <>
              ...
              <p className="text-sm sm:text-base text-zinc-500 dark:text-zinc-300 mb-6">
          ...
          {selectedSlide === 1 && (
            <>
              ...
              <p className="text-base sm:text-lg text-zinc-700 dark:text-zinc-200 text-center mt-4 leading-10">
                <code className="bg-zinc-700 dark:bg-zinc-900 text-white p-3 rounded-lg font-mono break-all">
                  {code}
                </code>
              </p>
              {error && (
                <p className="text-center mt-4">
                  <span className="bg-red-600 text-white p-2 mt-2 rounded-lg text-sm">
                    {error}
                  </span>
                </p>
              )}
